...
function your_theme_enqueue_scripts() {
    ...
    wp_enqueue_style( 'theme-style', get_stylesheet_directory_uri() . '/inc/css/base.css', array(), 20141119 );
    // all scripts
...
// Write form insert code here /////

if(isset($_POST['BtnSubmit'])){
	
	global $wpdb;
	$errors = array();
	if (!preg_match('/^[\p{L} ]+$/u', $_POST['first_name'])){
        $errors['first_name'] = '<p class="errText">Please enter your first name </p>';
	}
	if (!preg_match('/^[\p{L} ]+$/u', $_POST['last_name'])){
        $errors['last_name'] = '<p class="errText">Please enter your last name </p>';
	}
	if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL))
	{
		$errors['email'] = '<p class="errText">Email is not valid </p>';
	}
	...
	if (!$errors) {
		...
		if($rowResult == 1){
			header("Location: http://localhost:8888/yummy%20bites/index.php/success-page/");
		}
		else{
